        ...
        <div>
          <blockquote className="space-y-2">
            <p className="text-lg text-sidebar-foreground/90">
              &ldquo;Finding and borrowing books has never been easier. I can track all my borrowed books 
              and reserve new ones right from my dashboard.&rdquo;
            </p>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="rounded-md bg-muted p-3 text-sm">
                  ...
                  <p className="text-muted-foreground">Email: student@library.com</p>
